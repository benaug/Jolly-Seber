...
constants <- list(n.year=n.year, K=K, M=M, J=J, xlim=xlim, ylim=ylim, K1D=K1D)
#inits for Nimble
...
#data for Nimble
Nimdata <- list(y=y.nim,z=z.init,z.start=z.start.init,z.stop=z.stop.init,phi.cov=phi.cov.data)
